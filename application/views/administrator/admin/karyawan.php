                ...
                foreach ($tb_karyawan as $plg) : ?>
                 <tr>
                      ...
                      <td class="project-actions text-left">                        
                          ...
                          <a width="20px"><?php echo anchor('administrator/admin/karyawan/update/'.$plg->id,'<div class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></div>') ?>
                          </a>
                          <a width="20px"><?php echo anchor('administrator/admin/karyawan/delete/'.$plg->id,'<div class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></div>') ?>
                          </a>
                      </td>
